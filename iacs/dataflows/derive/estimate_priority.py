...
def effort_sum(updated_parent: ir.Table, components: dict) -> pd.DataFrame:
...
def priority_product(updated_parent: ir.Table, entity_id: ir.Table, components_with_resolved_paths: dict) -> pd.DataFrame:
